...
ExchangeModel.version    = '1.3.2.customizatiion'
ExchangeModel.isArray    = isArray
ExchangeModel.isBlank    = isBlank
ExchangeModel.$          = $
ExchangeModel.Events     = Events
ExchangeModel.Log        = Log
ExchangeModel.Module     = Module
ExchangeModel.Model      = Model

# Global events

Module.extend.call(ExchangeModel, Events)
